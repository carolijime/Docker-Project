...
public class UserService implements UserDetailsService {
    ...
    public void create(UserCreateRequest userCreateRequest) throws JsonProcessingException {
        ...
        // TODO: Publish the event post user creation which can be listened by other consumers
        //create JSON object
        ...
        //convert from json to string using object mapper and "send" the kafka message
